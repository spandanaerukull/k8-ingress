...
### OIDC provider # lt is like 3rd party authentication 
...
### Download IAM Policy # permissions 
...
### Create IAM Role and K8 ServiceAccount. # k8 is nothing but system account and we created here because to give permissions  
